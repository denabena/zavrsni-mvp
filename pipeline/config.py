...
N_CLUSTERS   = int(os.getenv("N_CLUSTERS", "13"))
...
# Prijašnji default je bio "sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2".
# Prebacili smo na e5-large jer mali model nije razlikovao algoritamske teme.
